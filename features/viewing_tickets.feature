Feature: Viewing tickets
	...
	As a user
	I want to see them on that's project's page
	...
	Background:
		...
		Scenario: Viewing tickets for a given project
			...
			Then I should see "Make it shiny" in the selector "#ticket h2"
			...
			Then I should see "Standards compliance" in the selector "#ticket h2"
